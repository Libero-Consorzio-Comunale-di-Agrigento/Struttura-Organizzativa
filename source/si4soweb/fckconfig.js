...
FCKConfig.LinkBrowserURL = '../../common/AmvDocUrl.do';
...
FCKConfig.LinkBrowserWindowWidth	= 300;	// 70%
FCKConfig.LinkBrowserWindowHeight	= 340;	// 70%

FCKConfig.AttachmentBrowser = true ;
FCKConfig.AttachmentBrowserURL = '../../common/AmvAttachSelect.do';
FCKConfig.AttachmentBrowserWindowWidth	= 300;	// 70%
FCKConfig.AttachmentBrowserWindowHeight	= 330;	// 70%
...
FCKConfig.ImageBrowserURL = '../../common/AmvImages.do';
//FCKConfig.ImageBrowserURL = FCKConfig.BasePath + 'filemanager/browser/default/test.htm';
...
FCKConfig.ImageBrowserWindowWidth  = 462;	// 70% ;
FCKConfig.ImageBrowserWindowHeight = 314;	// 70% ;
