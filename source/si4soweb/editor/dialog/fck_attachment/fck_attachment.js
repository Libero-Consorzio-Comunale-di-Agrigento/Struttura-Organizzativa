...
function Ok(){
	var sUri ;
	var docTitle = GetE('txtDocTitle').value;
	var extension = GetE('ext').value;
	...
	SetAttribute( oImage, 'src', '../common/images/AMV/'+extension+'.gif');
	...
	if(oTesto!=null && oTesto!='')
		...
		oLink.innerHTML = docTitle+'.'+extension;
