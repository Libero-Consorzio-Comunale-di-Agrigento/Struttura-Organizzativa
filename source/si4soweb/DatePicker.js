/******************************************************************************
 ...
 ---- ---------- ------ --------------------------------------------------------
 1    15/05/2003 AO     Richiamo dinamico del foglio di stile con id="AFC"
			Mesi e giorni in italiano
******************************************************************************/
//JS DatePicker @0-AD6AE1E3

// Date formatting functions begin ---------------------------------------------------

// Rev.1 Mesi e giorni in italiano
var listMonths = new Array("Gennaio", "Febbraio", "Marzo", "Aprile", "Maggio", "Giugno", "Luglio", "Agosto", "Settembre", "Ottobre", "Novembre", "Dicembre");
var listShortMonths = new Array("Gen", "Feb", "Mar", "Apr", "Mag", "Giu", "Lug", "Ago", "Set", "Ott", "Nov", "Dic");
var firstWeekDay = "Sun";
var listWeekdays = new Array("Domenica", "Lunedì", "Martedì", "Mercoledì", "Giovedì", "Venerdì", "Sabato");
var listShortWeekdays = new Array("Dom", "Lun", "Mar", "Mer", "Gio", "Ven", "Sab");
// Rev.1 Fine
...
// Rev.1 Richiamo dinamico del foglio di stile con id="AFC"
  DatePickerObject.style            = "Themes/" + document.styleSheets.item("AFC").href;
  if (navigator.appName.indexOf("Netscape") != -1) {
     DatePickerObject.style =  document.styleSheets[document.styleSheets.length-1].href;
  }
  //DatePickerObject.themePath        = DatePickerObject.style;
  DatePickerObject.themePath        = "Themes/AFC/";
// Rev.1 Fine
...
function buildBottom() 
{
  ...
  var datepickerDocument = (isNav?"<HTML>" + "<HEAD>" +
      ...
      "</HEAD>" +
      "<BODY class='AFCPageBODY' TOPMARGIN='0' LEFTMARGIN='0' ONUNLOAD='parent.opener.UnLoad();'>":"") + DatePickerBegin.replace(/{datepickerDocumentTop}/, datepickerDocumentTop);
...
function buildDatePickerParts()
{
  ...
  DatePickerEnd +=
      ...
      (isNav?"":"<FORM NAME='calTable' onSubmit='return false;'>") +
      "<TD>" +
      "<INPUT TYPE='button' CLASS='CalendarButtons' NAME='today' VALUE='Oggi' onClick=\"parent.opener.setToday()\">" + 
      "</TD>" + 
      (isNav?"":"</FORM>")+
      "</TABLE>" +
      (isNav?"</FORM>":"")+
