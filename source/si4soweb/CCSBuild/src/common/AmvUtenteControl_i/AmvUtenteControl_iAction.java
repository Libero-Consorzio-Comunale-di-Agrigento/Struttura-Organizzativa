//AmvUtenteControl_iAction imports @1-71262824
...
//End AmvUtenteControl_iAction imports

//AmvUtenteControl_iAction class @1-DE06ADFC
public class AmvUtenteControl_iAction extends Action {

//End AmvUtenteControl_iAction class

//AmvUtenteControl_iAction: method perform @1-2F3B5EF7
    public String perform( HttpServletRequest req, HttpServletResponse resp, ServletContext context ) {
        ...
        page = new AmvUtenteControl_iModel( (CCSLocale) SessionStorage.getInstance( req ).getAttribute(Names.CCS_LOCALE_KEY));
        if (req.getAttribute(page.getName()+"Parent")==null) page.setCharacterEncoding("windows-1252");
        page.setResponse(resp);
        page.setRequest(req);
        res = ResourceBundle.getBundle("MessagesBundle", page.getCCSLocale().getLocale());
        req.setAttribute( "AmvUtenteControl_iModel", page );
...
//End AmvUtenteControl_iAction: method perform

//AmvUtenteControl_iAction: call children actions @1-03B55C63
        if (result == null) {
...
//End AmvUtenteControl_iAction: call children actions
...
//UTENTE_CONTROL Grid: method bind @2-C97AA8DF
...
//UTENTE_CONTROL Directory: getRowFieldByName @2-9A32D2BF
...
//AmvUtenteControl_i Page: method validate @1-104025BA
    boolean validate() {
        return true;
    }
//End AmvUtenteControl_i Page: method validate

//AmvUtenteControl_iAction Tail @1-FCB6E20C
}
//End AmvUtenteControl_iAction Tail
