//AMV_VISTA_DOCUMENTISearchHandler Head @6-E718E287
...
public class AMV_VISTA_DOCUMENTISearchRecordHandler implements RecordListener {
//End AMV_VISTA_DOCUMENTISearchHandler Head

//BeforeShow Head @6-46046458
    public void beforeShow(Event e) {
//End BeforeShow Head

//Set values @6-D457C354
        if (! e.getRecord().isEditMode()) {
            e.getRecord().getControl("s_CERCA_TESTO").setDefaultValue(0);
        }
//End Set values
...
//AMV_VISTA_DOCUMENTISearchHandler Tail @6-FCB6E20C
}
//End AMV_VISTA_DOCUMENTISearchHandler Tail
