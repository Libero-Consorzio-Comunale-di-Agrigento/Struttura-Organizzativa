//AmvDocumentoViewModel imports @1-C86242B5
...
//End AmvDocumentoViewModel imports

//AmvDocumentoViewModel class head @1-92FDC541
public class AmvDocumentoViewModel extends com.codecharge.components.Page {
    public AmvDocumentoViewModel() {
        this( new CCSLocale(), null );
    }

    public AmvDocumentoViewModel(CCSLocale locale) {
        this( locale, null );
    }

    public AmvDocumentoViewModel( CCSLocale locale, HttpServletResponse response ) {
//End AmvDocumentoViewModel class head

//page settings @1-057E8190
        super("AmvDocumentoView", locale );
        setResponse(response);
        {
            com.codecharge.components.IncludePage AmvIncludeDoc__28 = new com.codecharge.components.IncludePage("AmvIncludeDoc", this );
            AmvIncludeDoc__28.setVisible( true );
            add( AmvIncludeDoc__28 );
        } // end page
//End page settings

//AMV_VISTA_DOCUMENTI grid @5-F87D5441
        ...
        */
        {
            ...
            com.codecharge.components.Label ALLEGATI__47 = new com.codecharge.components.Label("ALLEGATI", "ALLEGATI", this );
            ALLEGATI__47.setType( com.codecharge.components.ControlType.TEXT );
            AMV_VISTA_DOCUMENTI.add(ALLEGATI__47);
            add(AMV_VISTA_DOCUMENTI);
        } // End definition of AMV_VISTA_DOCUMENTI grid model
//End AMV_VISTA_DOCUMENTI grid

//AmvDocumentoViewModel class tail @1-F5FC18C5
    }
}
//End AmvDocumentoViewModel class tail
