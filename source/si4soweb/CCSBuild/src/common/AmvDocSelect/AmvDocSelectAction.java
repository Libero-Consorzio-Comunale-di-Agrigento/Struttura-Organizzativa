//AmvDocSelectAction imports @1-A5D73B47
...
//End AmvDocSelectAction imports

//AmvDocSelectAction class @1-BBEFAB3D
public class AmvDocSelectAction extends Action {

//End AmvDocSelectAction class

//AmvDocSelectAction: method perform @1-1DE73930
    public String perform( HttpServletRequest req, HttpServletResponse resp, ServletContext context ) {
        ...
        page = new AmvDocSelectModel( (CCSLocale) SessionStorage.getInstance( req ).getAttribute(Names.CCS_LOCALE_KEY));
        if (req.getAttribute(page.getName()+"Parent")==null) page.setCharacterEncoding("windows-1252");
        page.setResponse(resp);
        page.setRequest(req);
        res = ResourceBundle.getBundle("MessagesBundle", page.getCCSLocale().getLocale());
        req.setAttribute( "AmvDocSelectModel", page );
...
//End AmvDocSelectAction: method perform

//AmvDocSelectAction: call children actions @1-C43DF56A
...
//End AmvDocSelectAction: call children actions
...
//FILE_LIST Record: children actions @2-87528427
...
//AmvDocSelect Page: method validate @1-104025BA
    boolean validate() {
        return true;
    }
//End AmvDocSelect Page: method validate

//AmvDocSelectAction Tail @1-FCB6E20C
}
//End AmvDocSelectAction Tail
