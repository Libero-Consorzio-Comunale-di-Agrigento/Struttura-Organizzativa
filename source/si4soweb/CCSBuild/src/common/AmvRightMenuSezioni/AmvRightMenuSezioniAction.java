//AmvRightMenuSezioniAction imports @1-71168B67
...
//End AmvRightMenuSezioniAction imports

//AmvRightMenuSezioniAction class @1-208DBB87
public class AmvRightMenuSezioniAction extends Action {

//End AmvRightMenuSezioniAction class

//AmvRightMenuSezioniAction: method perform @1-186D8011
    public String perform( HttpServletRequest req, HttpServletResponse resp, ServletContext context ) {
        ...
        page = new AmvRightMenuSezioniModel( (CCSLocale) SessionStorage.getInstance( req ).getAttribute(Names.CCS_LOCALE_KEY));
        if (req.getAttribute(page.getName()+"Parent")==null) page.setCharacterEncoding("windows-1252");
        page.setResponse(resp);
        page.setRequest(req);
        res = ResourceBundle.getBundle("MessagesBundle", page.getCCSLocale().getLocale());
        req.setAttribute( "AmvRightMenuSezioniModel", page );
...
//End AmvRightMenuSezioniAction: method perform

//AmvRightMenuSezioniAction: call children actions @1-5EFC100A
        if (result == null) {
...
//End AmvRightMenuSezioniAction: call children actions
...
//AmvRightMenuSezioni Page: method validate @1-104025BA
    boolean validate() {
        return true;
    }
//End AmvRightMenuSezioni Page: method validate

//AmvRightMenuSezioniAction Tail @1-FCB6E20C
}
//End AmvRightMenuSezioniAction Tail
