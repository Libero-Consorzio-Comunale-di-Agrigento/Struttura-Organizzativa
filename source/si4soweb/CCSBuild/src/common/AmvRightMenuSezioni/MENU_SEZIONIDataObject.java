//MENU_SEZIONI DataSource @79-F3AAACE7
...
//load @79-7787839F
    boolean load() {
        ...
        command.setSql( "select AMV_SEZIONE.GET_MENU('{Utente}','D',{MVSZ},'{MVPC}') BLOCCO from dual " );
        ...
        command.setCountSql( "SELECT COUNT(*) FROM ( select AMV_SEZIONE.GET_MENU('{Utente}','D',{MVSZ},'{MVPC}') BLOCCO from dual  ) cnt " );
