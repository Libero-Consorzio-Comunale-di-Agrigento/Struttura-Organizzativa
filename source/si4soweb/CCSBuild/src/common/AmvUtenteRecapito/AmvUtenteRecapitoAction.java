...
//AmvUtenteRecapitoAction imports @1-5F2B9F10
...
//End AmvUtenteRecapitoAction imports

//AmvUtenteRecapitoAction class @1-9C6F374E
public class AmvUtenteRecapitoAction extends Action {

//End AmvUtenteRecapitoAction class

//AmvUtenteRecapitoAction: method perform @1-92428970
    public String perform( HttpServletRequest req, HttpServletResponse resp, ServletContext context ) {
        ...
        page = new AmvUtenteRecapitoModel( (CCSLocale) SessionStorage.getInstance( req ).getAttribute(Names.CCS_LOCALE_KEY));
        if (req.getAttribute(page.getName()+"Parent")==null) page.setCharacterEncoding("windows-1252");
        page.setResponse(resp);
        page.setRequest(req);
        res = ResourceBundle.getBundle("MessagesBundle", page.getCCSLocale().getLocale());
        req.setAttribute( "AmvUtenteRecapitoModel", page );
...
//End AmvUtenteRecapitoAction: method perform

//AmvUtenteRecapitoAction: call children actions @1-B137504F
...
//End AmvUtenteRecapitoAction: call children actions
...
//AD4_UTENTI Record: method perform @6-BD484C01
...
//Button_Update Button @26-4109C344
...
//Button_Cancel Button @28-2570276A
...
//AD4_UTENTI Record: getRowFieldByName @6-DAAC4637
...
//AD4_UTENTI Record: method validate @6-3C6CCBE1
        boolean validate() {
...
//AmvUtenteRecapito Page: method validate @1-104025BA
    boolean validate() {
        return true;
    }
//End AmvUtenteRecapito Page: method validate

//AmvUtenteRecapitoAction Tail @1-FCB6E20C
}
//End AmvUtenteRecapitoAction Tail
