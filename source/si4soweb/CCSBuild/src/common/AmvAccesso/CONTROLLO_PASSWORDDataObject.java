//CONTROLLO_PASSWORD DataSource @9-0428D2DB
...
//End CONTROLLO_PASSWORD DataSource

//class DataObject Header @9-BBA8DC6A
public class CONTROLLO_PASSWORDDataObject extends DS {
//End class DataObject Header

//attributes of DataObject @9-37A4DFCA
    ...
    private CONTROLLO_PASSWORDRow[] rows = new CONTROLLO_PASSWORDRow[100];
...
//properties of DataObject @9-1426A391
    ...
    public CONTROLLO_PASSWORDRow[] getRows() {
        return rows;
    }

    public void setRows(CONTROLLO_PASSWORDRow[] rows) {
        this.rows = rows;
    }
...
//constructor @9-54F83FB6
    public CONTROLLO_PASSWORDDataObject(Page page) {
        super(page);
    }
//End constructor
...
//load @9-1905A37F
    boolean load() {
        ...
        command.setSql( "select AMV_UTENTE.IS_PWD_VALIDA('{Utente}','{Modulo}','{Istanza}','{Progetto}') PWD "
                    + "  from dual "
                    + " where '{Utente}' != 'GUEST'" );
        ...
        command.setCountSql( "SELECT COUNT(*) FROM ( select AMV_UTENTE.IS_PWD_VALIDA('{Utente}','{Modulo}','{Istanza}','{Progetto}') PWD from dual where '{Utente}' != 'GUEST' ) cnt " );
...
//loadDataBind @9-1052F426
        if ( records == null || ! records.hasMoreElements() ) {
            empty = true;
        } else {
            int counter = 0;
            while ( counter < rows.length && records.hasMoreElements() ) {
                CONTROLLO_PASSWORDRow row = new CONTROLLO_PASSWORDRow();
