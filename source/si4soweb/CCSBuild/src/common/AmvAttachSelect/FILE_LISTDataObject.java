//FILE_LIST DataSource @2-F089031F
...
//attributes of DataObject @2-76F9ABF7
...
//properties of DataObject @2-F8F028FD
...
//loadDataBind @2-72160028
        if ( record == null || record.isEmpty() ) {
            empty = true;
        } else {
            row.setTITOLO(Utils.convertToString(ds.parse(record.get("TITOLO"), row.getTITOLOField())));
            row.setDOCUMENTO(Utils.convertToString(ds.parse(record.get("VALORE"), row.getDOCUMENTOField())));
        }
//End loadDataBind
