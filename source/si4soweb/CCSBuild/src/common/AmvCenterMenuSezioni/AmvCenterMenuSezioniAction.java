//AmvCenterMenuSezioniAction imports @1-C2B4C9C5
...
//End AmvCenterMenuSezioniAction imports

//AmvCenterMenuSezioniAction class @1-E16742DC
public class AmvCenterMenuSezioniAction extends Action {

//End AmvCenterMenuSezioniAction class

//AmvCenterMenuSezioniAction: method perform @1-01EAA381
    public String perform( HttpServletRequest req, HttpServletResponse resp, ServletContext context ) {
        ...
        page = new AmvCenterMenuSezioniModel( (CCSLocale) SessionStorage.getInstance( req ).getAttribute(Names.CCS_LOCALE_KEY));
        if (req.getAttribute(page.getName()+"Parent")==null) page.setCharacterEncoding("windows-1252");
        page.setResponse(resp);
        page.setRequest(req);
        res = ResourceBundle.getBundle("MessagesBundle", page.getCCSLocale().getLocale());
        req.setAttribute( "AmvCenterMenuSezioniModel", page );
...
//End AmvCenterMenuSezioniAction: method perform

//AmvCenterMenuSezioniAction: call children actions @1-5EFC100A
        if (result == null) {
...
//End AmvCenterMenuSezioniAction: call children actions
...
//AmvCenterMenuSezioni Page: method validate @1-104025BA
    boolean validate() {
        return true;
    }
//End AmvCenterMenuSezioni Page: method validate

//AmvCenterMenuSezioniAction Tail @1-FCB6E20C
}
//End AmvCenterMenuSezioniAction Tail
