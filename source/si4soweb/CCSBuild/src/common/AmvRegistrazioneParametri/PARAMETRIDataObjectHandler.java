//PARAMETRIDataObjectHandler head @6-04414A60
...
public class PARAMETRIDataObjectHandler implements EditableGridDataObjectListener {
//End PARAMETRIDataObjectHandler head
...
//Event AfterExecuteUpdate Action Custom Code @24-44795B7A
/* -------------------------- *
 ...
 * -------------------------- */
  ...
  System.out.println("Pagina di ridirezione" + e.getPage().getRedirectString());
...
//PARAMETRIDataObjectHandler Tail @6-FCB6E20C
}
//End PARAMETRIDataObjectHandler Tail
