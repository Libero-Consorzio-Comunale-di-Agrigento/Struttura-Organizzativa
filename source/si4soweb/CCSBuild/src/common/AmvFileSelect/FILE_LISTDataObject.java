//FILE_LIST DataSource @2-9A95DA47
...
//attributes of DataObject @2-7CEFD8D5
    ...
    TextField urlMVWF = new TextField(null, null);
...
//properties of DataObject @2-13C0508F
    ...
    public void  setUrlMVWF( String param ) {
        this.urlMVWF.setValue( param );
    }

    public void  setUrlMVWF( Object param ) {
        this.urlMVWF.setValue( param );
    }

    public void  setUrlMVWF( Object param, Format ignore ) {
        this.urlMVWF.setValue( param );
    }
...
//load @2-ED7E1D55
    boolean load() {
        ...
        if ( StringUtils.isEmpty( (String) urlMVWF.getObjectValue() ) ) urlMVWF.setValue( "" );
        command.addParameter( "MVWF", urlMVWF, null );
...
//loadDataBind @2-603C0213
        if ( record == null || record.isEmpty() ) {
            empty = true;
        } else {
            row.setTITOLO(Utils.convertToString(ds.parse(record.get("TITOLO"), row.getTITOLOField())));
            row.setMVWF(Utils.convertToString(ds.parse(record.get("MVWF"), row.getMVWFField())));
...
//getParameterByName @2-0E8E1986
        public Parameter getParameterByName(String name, ParameterSource parameterSource) {
            ...
            if ( "MVWF".equals(name) && "url".equals(prefix) ) {
                param = urlMVWF;
            } else if ( "MVWF".equals(name) && prefix == null ) {
                param = urlMVWF;
            }
