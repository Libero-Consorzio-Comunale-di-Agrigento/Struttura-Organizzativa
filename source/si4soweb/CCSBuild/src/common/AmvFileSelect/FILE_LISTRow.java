//FILE_LISTRow: import @2-55A969D6
...
//FILE_LISTRow: declare fiels @2-0FAC26AA
    private TextField TITOLO = new TextField("TITOLO", "TITOLO");
    private TextField MVWF = new TextField("MVWF", "MVWF");
...
//FILE_LISTRow: method(s) of MVWF @17-1BCBFF42
    public TextField getMVWFField() {
        return MVWF;
    }

    public String getMVWF() {
        return MVWF.getValue();
    }

    public void setMVWF(String value) {
        this.MVWF.setValue(value);
    }
//End FILE_LISTRow: method(s) of MVWF
