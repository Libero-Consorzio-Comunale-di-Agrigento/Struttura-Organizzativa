//AmvEditAction imports @1-70EC7F00
...
//End AmvEditAction imports

//AmvEditAction class @1-CE6E4830
public class AmvEditAction extends Action {

//End AmvEditAction class

//AmvEditAction: method perform @1-92AD9983
    public String perform( HttpServletRequest req, HttpServletResponse resp, ServletContext context ) {
        ...
        page = new AmvEditModel( (CCSLocale) SessionStorage.getInstance( req ).getAttribute(Names.CCS_LOCALE_KEY));
        if (req.getAttribute(page.getName()+"Parent")==null) page.setCharacterEncoding("windows-1252");
        page.setResponse(resp);
        page.setRequest(req);
        res = ResourceBundle.getBundle("MessagesBundle", page.getCCSLocale().getLocale());
        req.setAttribute( "AmvEditModel", page );
...
//End AmvEditAction: method perform

//AmvEditAction: call children actions @1-2BC8E277
        if (result == null) {
...
//End AmvEditAction: call children actions
...
//NOTE Record: init DataSource @2-2CA479C9
            if (!model.isAllowRead()) return;
...
//NOTE Record: getRowFieldByName @2-87FC62D1
...
//NOTE Record: method validate @2-80F1AF82
        boolean validate() {
...
//AmvEdit Page: method validate @1-104025BA
    boolean validate() {
        return true;
    }
//End AmvEdit Page: method validate

//AmvEditAction Tail @1-FCB6E20C
}
//End AmvEditAction Tail
