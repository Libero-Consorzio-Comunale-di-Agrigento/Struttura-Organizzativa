//AmvImageSelectAction imports @1-EACB123B
...
//End AmvImageSelectAction imports

//AmvImageSelectAction class @1-9A4D0C67
public class AmvImageSelectAction extends Action {

//End AmvImageSelectAction class

//AmvImageSelectAction: method perform @1-2ACB6D3E
    public String perform( HttpServletRequest req, HttpServletResponse resp, ServletContext context ) {
        ...
        page = new AmvImageSelectModel( (CCSLocale) SessionStorage.getInstance( req ).getAttribute(Names.CCS_LOCALE_KEY));
        if (req.getAttribute(page.getName()+"Parent")==null) page.setCharacterEncoding("windows-1252");
        page.setResponse(resp);
        page.setRequest(req);
        res = ResourceBundle.getBundle("MessagesBundle", page.getCCSLocale().getLocale());
        req.setAttribute( "AmvImageSelectModel", page );
...
//End AmvImageSelectAction: method perform

//AmvImageSelectAction: call children actions @1-C43DF56A
...
//End AmvImageSelectAction: call children actions
...
//FILE_LIST Record: init DataSource @2-97FA0741
            if (!model.isAllowRead()) return;
            ...
            ds.setUrlMVIF( page.getHttpGetParams().getParameter("MVIF") );
...
//FILE_LIST Record: bind @2-AD0B8C1A
            public void bind(com.codecharge.components.Component model, FILE_LISTRow row ) {
                ...
                model.getControl("MVIF").setValue(row.getMVIF());
...
//AmvImageSelect Page: method validate @1-104025BA
    boolean validate() {
        return true;
    }
//End AmvImageSelect Page: method validate

//AmvImageSelectAction Tail @1-FCB6E20C
}
//End AmvImageSelectAction Tail
