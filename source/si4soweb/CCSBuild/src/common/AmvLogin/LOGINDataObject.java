...
//attributes of DataObject @2-D54BE805
...
//properties of DataObject @2-74825847
...
//load @2-310E911D
    boolean load() {
        ...
        command.setSql( "select 'Accesso negato.<br>Autenticazione fallita.' ERRORE, "
                    + "       '<a href=\"../common/AmvLostLogin.do\">Dimenticata Username e/o Password?</a>' LOSTMSG "
                    + "from dual "
                    + "WHERE '{MVERR}' = 'S'" );
...
//loadDataBind @2-CBA818E2
        if ( record == null || record.isEmpty() ) {
            empty = true;
        } else {
            row.setERRORE(Utils.convertToString(ds.parse(record.get("ERRORE"), row.getERROREField())));
            row.setLOSTMSG(Utils.convertToString(ds.parse(record.get("LOSTMSG"), row.getLOSTMSGField())));
        }
//End loadDataBind
