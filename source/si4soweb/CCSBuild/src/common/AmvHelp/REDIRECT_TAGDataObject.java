//REDIRECT_TAG DataSource @2-F83947FD
...
//attributes of DataObject @2-11A62466
...
//properties of DataObject @2-23C43CC4
    ...
    public void  setPostMVPAGEINDEX( long param, Format ignore ) {
        this.postMVPAGEINDEX.setValue( param );
    }
    ...
    public void  setUrlMVPAGEINDEXURL( long param, Format ignore ) {
        this.urlMVPAGEINDEXURL.setValue( param );
    }
...
//load @2-CE4ED9C8
    boolean load() {
        ...
        command.setSql( "select AMV_MENU.GET_PAGE(nvl('{MVPAGETYPE}','{MVPAGETYPEURL}'),nvl('{MVPAGES}','{MVPAGESURL}'),nvl({MVPAGEINDEX},{MVPAGEINDEXURL})) redirect from dual" );
        ...
        command.setCountSql( "SELECT COUNT(*) FROM ( select AMV_MENU.GET_PAGE(nvl('{MVPAGETYPE}','{MVPAGETYPEURL}'),nvl('{MVPAGES}','{MVPAGESURL}'),nvl({MVPAGEINDEX},{MVPAGEINDEXURL})) redirect from dual ) cnt " );
