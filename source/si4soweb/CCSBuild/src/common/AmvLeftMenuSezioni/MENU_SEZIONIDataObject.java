//MENU_SEZIONI DataSource @79-42B3D59E
...
//load @79-8C778EE2
    boolean load() {
        ...
        command.setSql( "select AMV_SEZIONE.GET_MENU('{Utente}','S',{MVSZ},'{MVPC}') BLOCCO from dual " );
        ...
        command.setCountSql( "SELECT COUNT(*) FROM ( select AMV_SEZIONE.GET_MENU('{Utente}','S',{MVSZ},'{MVPC}') BLOCCO from dual  ) cnt " );
