...
//End Zona_S DataSource

//class DataObject Header @34-F289503C
public class Zona_SDataObject extends DS {
//End class DataObject Header

//attributes of DataObject @34-41C9117D
    ...
    private Zona_SRow[] rows = new Zona_SRow[20];
...
//properties of DataObject @34-031CED53
    ...
    public Zona_SRow[] getRows() {
        return rows;
    }

    public void setRows(Zona_SRow[] rows) {
        this.rows = rows;
    }
...
//constructor @34-20D0A65E
    public Zona_SDataObject(Page page) {
        super(page);
    }
//End constructor
...
//load @34-A5D451B8
    boolean load() {
        ...
        command.setCountSql( "SELECT COUNT(*) FROM ( select AMV_DOCUMENTO.GET_BLOCCO_TIPOLOGIA( '{Utente}', id_tipologia ,  "
                                                         + "            {MVSZ}) blocco from amv_tipologie where zona = 'S'  ) cnt " );
...
//loadDataBind @34-1F026BDC
        if ( records == null || ! records.hasMoreElements() ) {
            empty = true;
        } else {
            int counter = 0;
            while ( counter < rows.length && records.hasMoreElements() ) {
                Zona_SRow row = new Zona_SRow();
                DbRow record = (DbRow) records.nextElement();
                row.setZONA_S(Utils.convertToString(ds.parse(record.get("BLOCCO"), row.getZONA_SField())));
