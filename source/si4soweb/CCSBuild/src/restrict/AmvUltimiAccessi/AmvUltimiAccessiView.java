//AmvUltimiAccessiView imports @1-621B76B0
...
//End AmvUltimiAccessiView imports

//AmvUltimiAccessiView class @1-E6159F61
public class AmvUltimiAccessiView extends View {
//End AmvUltimiAccessiView class

//AmvUltimiAccessiView: method show @1-961C6479
    public String show( HttpServletRequest req, HttpServletResponse resp, ServletContext context ) {
        this.page = (AmvUltimiAccessiModel) req.getAttribute( "AmvUltimiAccessiModel" );
        if (this.page == null) return "";
        String enc = (req.getAttribute(page.getName()+"Parent")!=null) ? ((com.codecharge.components.Page) req.getAttribute(page.getName()+"Parent")).getCharacterEncoding() : null;
        page.setCharacterEncoding("windows-1252");
        this.tmplPath = "/restrict/AmvUltimiAccessi.html";
...
//End AmvUltimiAccessiView: method show
...
//AmvUltimiAccessiView Tail @1-FCB6E20C
}
//End AmvUltimiAccessiView Tail
