//AmvRichiesteAutoreModel imports @1-48B83ECF
...
//End AmvRichiesteAutoreModel imports

//AmvRichiesteAutoreModel class head @1-6136065B
public class AmvRichiesteAutoreModel extends com.codecharge.components.Page {
    public AmvRichiesteAutoreModel() {
        this( new CCSLocale(), null );
    }

    public AmvRichiesteAutoreModel(CCSLocale locale) {
        this( locale, null );
    }

    public AmvRichiesteAutoreModel( CCSLocale locale, HttpServletResponse response ) {
//End AmvRichiesteAutoreModel class head

//page settings @1-222DB030
        super("AmvRichiesteAutore", locale );
...
//AMV_VISTA_DOCUMENTISearch record @6-89DFBE34
        ...
        */
        {
            ...
            AMV_VISTA_DOCUMENTISearch.setReturnPage("AmvRichiesteAutore" + Names.ACTION_SUFFIX);
            ...
            com.codecharge.components.ListBox s_MODELLO__88 = new com.codecharge.components.ListBox("s_MODELLO", "", this );
            s_MODELLO__88.setType( com.codecharge.components.ControlType.TEXT );
            s_MODELLO__88.setHtmlEncode( true );
            s_MODELLO__88.setBoundColumn( "ID_DOCUMENTO" );
            s_MODELLO__88.setTextColumn( "TITOLO" );
            AMV_VISTA_DOCUMENTISearch.add( s_MODELLO__88 );
...
//AMV_VISTA_DOCUMENTI grid @5-07561960
        ...
        */
        {
            ...
            com.codecharge.components.Label MODELLO__68 = new com.codecharge.components.Label("MODELLO", "MODELLO", this );
            MODELLO__68.setType( com.codecharge.components.ControlType.TEXT );
            MODELLO__68.setHtmlEncode( true );
            AMV_VISTA_DOCUMENTI.add(MODELLO__68);
...
//AmvRichiesteAutoreModel class tail @1-F5FC18C5
    }
}
//End AmvRichiesteAutoreModel class tail
