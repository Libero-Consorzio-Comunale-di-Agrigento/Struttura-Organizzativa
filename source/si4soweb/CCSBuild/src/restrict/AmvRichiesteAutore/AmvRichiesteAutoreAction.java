//AmvRichiesteAutoreAction imports @1-CB4567FF
...
//End AmvRichiesteAutoreAction imports

//AmvRichiesteAutoreAction class @1-3FC5588B
public class AmvRichiesteAutoreAction extends Action {

//End AmvRichiesteAutoreAction class

//AmvRichiesteAutoreAction: method perform @1-1ED04448
    public String perform( HttpServletRequest req, HttpServletResponse resp, ServletContext context ) {
        ...
        page = new AmvRichiesteAutoreModel( (CCSLocale) SessionStorage.getInstance( req ).getAttribute(Names.CCS_LOCALE_KEY));
        if (req.getAttribute(page.getName()+"Parent")==null) page.setCharacterEncoding("windows-1252");
        page.setResponse(resp);
        page.setRequest(req);
        res = ResourceBundle.getBundle("MessagesBundle", page.getCCSLocale().getLocale());
        req.setAttribute( "AmvRichiesteAutoreModel", page );
...
//End AmvRichiesteAutoreAction: method perform

//AmvRichiesteAutoreAction: call children actions @1-6124737C
...
//End AmvRichiesteAutoreAction: call children actions
...
//AMV_VISTA_DOCUMENTISearch Record: method perform @6-259438E6
        String perform(com.codecharge.components.Record model) {
            //e = new ActionEvent( model, page );
            this.model = model;
            if ( ! model.isVisible() ) { return null;}
            StringBuffer performReturnPage = new StringBuffer( "AmvRichiesteAutore" + Names.ACTION_SUFFIX );
            performReturnPage.append( "?" + page.getHttpGetParams().toString( model.getExcludeParams() ) );
            page.setRedirectString( performReturnPage.toString() );
//End AMV_VISTA_DOCUMENTISearch Record: method perform

//AMV_VISTA_DOCUMENTISearch Record: children actions @6-917CCBBB
...
//DoSearch Button @7-0BB5D912
        void DoSearchSearchAction() {
            ...
            page.setRedirectString( "AmvRichiesteAutore" + Names.ACTION_SUFFIX + "?" + page.getHttpGetParams().toString( excludeParams ) + "&" + page.getHttpPostParams().toString( buttonModel.getExcludeParams() ) );
            buttonModel.fireOnClickEvent();
        }
//End DoSearch Button

//ListBoxAction @88-54F3697E
        protected void reads_MODELLO(com.codecharge.components.ListBox model) {
            ...
            command.setSql( "select id_documento,  "
                        ...
                        + "  and stato in ('U','R') "
                        + "  and instr(LINK, 'iter=N inoltro=I') < 1 "
                        + "  " );
...
//AMV_VISTA_DOCUMENTISearch Record: method validate @6-E8985DEF
        boolean validate() {
...
//AMV_VISTA_DOCUMENTI Grid: set where parameters @5-8D2EC325
...
//AMV_VISTA_DOCUMENTI Grid: set grid properties @5-68263A89
...
//AMV_VISTA_DOCUMENTI Grid: method bind @5-99EFAC78
...
//AMV_VISTA_DOCUMENTI Directory: getRowFieldByName @5-F968D3BF
...
//AmvRichiesteAutore Page: method validate @1-104025BA
    boolean validate() {
        return true;
    }
//End AmvRichiesteAutore Page: method validate

//AmvRichiesteAutoreAction Tail @1-FCB6E20C
}
//End AmvRichiesteAutoreAction Tail
