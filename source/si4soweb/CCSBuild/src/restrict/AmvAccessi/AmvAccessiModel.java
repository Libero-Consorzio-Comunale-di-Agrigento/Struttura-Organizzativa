//AmvAccessiModel imports @1-1D47E408
...
//End AmvAccessiModel imports

//AmvAccessiModel class head @1-CAD710F8
public class AmvAccessiModel extends com.codecharge.components.Page {
    public AmvAccessiModel() {
        this( new CCSLocale(), null );
    }

    public AmvAccessiModel(CCSLocale locale) {
        this( locale, null );
    }

    public AmvAccessiModel( CCSLocale locale, HttpServletResponse response ) {
//End AmvAccessiModel class head

//page settings @1-40FC089F
        super("AmvAccessi", locale );
        ...
        */
        {
            ...
            AD4_UTENTI.setReturnPage("AmvAccessi" + Names.ACTION_SUFFIX);
...
//AmvAccessiModel class tail @1-F5FC18C5
    }
}
//End AmvAccessiModel class tail
