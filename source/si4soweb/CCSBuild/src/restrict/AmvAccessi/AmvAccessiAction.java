//AmvAccessiAction imports @1-28E459AF
...
//End AmvAccessiAction imports

//AmvAccessiAction class @1-4A38A52D
public class AmvAccessiAction extends Action {

//End AmvAccessiAction class

//AmvAccessiAction: method perform @1-D7E3E28B
    public String perform( HttpServletRequest req, HttpServletResponse resp, ServletContext context ) {
        ...
        page = new AmvAccessiModel( (CCSLocale) SessionStorage.getInstance( req ).getAttribute(Names.CCS_LOCALE_KEY));
        if (req.getAttribute(page.getName()+"Parent")==null) page.setCharacterEncoding("windows-1252");
        page.setResponse(resp);
        page.setRequest(req);
        res = ResourceBundle.getBundle("MessagesBundle", page.getCCSLocale().getLocale());
        req.setAttribute( "AmvAccessiModel", page );
...
//End AmvAccessiAction: method perform

//AmvAccessiAction: call children actions @1-660B0F6D
...
//End AmvAccessiAction: call children actions
...
//AD4_UTENTI Record: method perform @6-37CD06C8
        String perform(com.codecharge.components.Record model) {
            //e = new ActionEvent( model, page );
            this.model = model;
            if ( ! model.isVisible() ) { return null;}
            StringBuffer performReturnPage = new StringBuffer( "AmvAccessi" + Names.ACTION_SUFFIX );
...
//AD4_UTENTI Record: init DataSource @6-FD7F3534
            if (!model.isAllowRead()) return;
...
//AD4_DIRITTI_ACCESSO Grid: set where parameters @22-2B0125CF
            ds.setSesUtente( SessionStorage.getInstance(req).getAttribute("Utente") );
...
//AmvAccessi Page: method validate @1-104025BA
    boolean validate() {
        return true;
    }
//End AmvAccessi Page: method validate

//AmvAccessiAction Tail @1-FCB6E20C
}
//End AmvAccessiAction Tail
