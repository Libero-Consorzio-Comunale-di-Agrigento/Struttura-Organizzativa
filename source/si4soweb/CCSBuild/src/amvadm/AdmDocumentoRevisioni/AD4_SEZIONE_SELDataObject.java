//AD4_SEZIONE_SEL DataSource @10-B8CD6794
...
//attributes of DataObject @10-6A6A34A9
...
//properties of DataObject @10-1C4910AB
...
//load @10-692C5122
    boolean load() {
        ...
        command.setSql( "SELECT titolo "
                    ...
                    + "        , 'R' , '' "
                    + "        ,  "
                    + "'<a href=\"../amvadm/AdmRevisioneNuova.do>Nuova&nbsp;revisione...&nbsp;</i></a>' "
                    + "        ) new_page  "
                    + "FROM amv_documenti  "
        ...
        command.setCountSql( "SELECT COUNT(*) FROM ( SELECT titolo ,  "
                                                         ...
                                                         + "            '<a href=\"../amvadm/AdmRevisioneNuova.do>Nuova&nbsp;revisione...&nbsp;</i></a>' ) new_page FROM amv_documenti WHERE id_documento = {ID} and revisione = {REV} ) cnt " );
...
//loadDataBind @10-4B92B524
        if ( records == null || ! records.hasMoreElements() ) {
            ...
            while ( counter < rows.length && records.hasMoreElements() ) {
                ...
                row.setLabel1(Utils.convertToString(ds.parse(record.get("NEW_PAGE"), row.getLabel1Field())));
                rows[counter++] = row;
            }
        }
//End loadDataBind
