//AD4_UTENTI DataSource @5-EECC6A97
...
//attributes of DataObject @5-09A4B2DC
...
//properties of DataObject @5-22DB9DF5
...
//load @5-C0C5F92F
    boolean load() {
        ...
        command.setCountSql( "SELECT COUNT(*) FROM ( SELECT distinct u.utente , u.nominativo ,  "
