//AMV_RILEVANZE1 DataSource @14-78234865
...
//End AMV_RILEVANZE1 DataSource

//class DataObject Header @14-D12BE07A
public class AMV_RILEVANZE1DataObject extends DS {
//End class DataObject Header

//attributes of DataObject @14-9203E5B6
    

    LongField urlID = new LongField(null, null);
    

    private AMV_RILEVANZE1Row row = new AMV_RILEVANZE1Row();

//End attributes of DataObject

//properties of DataObject @14-C1ED64E6
    ...
    public AMV_RILEVANZE1Row getRow() {
        return row;
    }

    public void setRow( AMV_RILEVANZE1Row row ) {
        this.row = row;
    }

//End properties of DataObject

//constructor @14-ECA35A3F
    public AMV_RILEVANZE1DataObject(Page page) {
        super(page);
    }
//End constructor
...
//insert @14-4816A2CD
        boolean insert() {
            ...
            command.setSql("INSERT INTO AMV_RILEVANZE ( NOME, IMPORTANZA, SEQUENZA, ZONA, ZONA_VISIBILITA, ZONA_FORMATO, IMMAGINE, MAX_VIS, ID_RILEVANZA ) VALUES ( {NOME}, {IMPORTANZA}, {SEQUENZA}, {ZONA}, {ZONA_VISIBILITA}, {ZONA_FORMATO}, {IMMAGINE}, {MAX_VIS}, {ID_RILEVANZA} )");
...
//update @14-908A8417
        boolean update() {
            ...
            command.setNeedQuotes(true);
            command.setSql("UPDATE AMV_RILEVANZE SET NOME = {NOME}, IMPORTANZA = {IMPORTANZA}, SEQUENZA = {SEQUENZA}, ZONA = {ZONA}, ZONA_VISIBILITA = {ZONA_VISIBILITA}, ZONA_FORMATO = {ZONA_FORMATO}, IMMAGINE = {IMMAGINE}, MAX_VIS = {MAX_VIS}, ID_RILEVANZA = {ID_RILEVANZA}");
            command.addParameter("NOME", row.getNOMEField());
            command.addParameter("IMPORTANZA", row.getIMPORTANZAField());
            command.addParameter("SEQUENZA", row.getSEQUENZAField());
            command.addParameter("ZONA", row.getZONAField());
