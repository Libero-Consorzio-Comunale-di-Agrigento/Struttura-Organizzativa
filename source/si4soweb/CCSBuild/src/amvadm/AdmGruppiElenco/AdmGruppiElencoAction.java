//AdmGruppiElencoAction imports @1-D587CF50
...
//End AdmGruppiElencoAction imports

//AdmGruppiElencoAction class @1-C90B52BC
public class AdmGruppiElencoAction extends Action {

//End AdmGruppiElencoAction class

//AdmGruppiElencoAction: method perform @1-DFE9213F
    public String perform( HttpServletRequest req, HttpServletResponse resp, ServletContext context ) {
        ...
        page = new AdmGruppiElencoModel( (CCSLocale) SessionStorage.getInstance( req ).getAttribute(Names.CCS_LOCALE_KEY));
        if (req.getAttribute(page.getName()+"Parent")==null) page.setCharacterEncoding("windows-1252");
        page.setResponse(resp);
        page.setRequest(req);
        res = ResourceBundle.getBundle("MessagesBundle", page.getCCSLocale().getLocale());
        req.setAttribute( "AdmGruppiElencoModel", page );
...
//End AdmGruppiElencoAction: method perform

//AdmGruppiElencoAction: call children actions @1-EE05DF12
...
//End AdmGruppiElencoAction: call children actions
...
//AD4_UTENTISearch Record: method perform @6-860990B4
        String perform(com.codecharge.components.Record model) {
            //e = new ActionEvent( model, page );
            this.model = model;
            if ( ! model.isVisible() ) { return null;}
            StringBuffer performReturnPage = new StringBuffer( "AdmGruppiElenco" + Names.ACTION_SUFFIX );
...
//DoSearch Button @7-EEBE9A62
        void DoSearchSearchAction() {
            ...
            page.setRedirectString( "AdmGruppiElenco" + Names.ACTION_SUFFIX + "?"  + "&" + page.getHttpPostParams().toString( buttonModel.getExcludeParams() ) );
...
//AD4_UTENTISearch Record: bind @6-CA1AA6BC
...
//AD4_UTENTISearch Record: getRowFieldByName @6-068D5CDE
...
//AD4_UTENTISearch Record: method validate @6-0D08F860
        boolean validate() {
...
//AD4_UTENTI Grid: set where parameters @5-18ABF531
...
//AD4_UTENTI Grid: set grid properties @5-C16D4E83
            
            ds.setPageNum( (model.getPage() < 1 ? 1 : model.getPage()) );
            ds.setPageSize( model.getFetchSize() );
            Hashtable sortAscColumns = new Hashtable();
            Hashtable sortDescColumns = new Hashtable();
            sortAscColumns.put( "Sorter_NOMINATIVO", "NOME_GRUPPO" );
...
//AD4_UTENTI Grid: method bind @5-67953760
        public void bind(com.codecharge.components.Component model, AD4_UTENTIRow[] rows ) {
            ...
            while ( counter < rows.length && rows[counter] != null ) {
                ...
                c = (com.codecharge.components.Control) hashRow.get("NOME_GRUPPO");
                if ( c == null ) { 
                    c = (com.codecharge.components.Control) model.getControl("NOME_GRUPPO").clone();
                    c.setValue(row.getNOME_GRUPPO());
                ...
                c = (com.codecharge.components.Control) hashRow.get("DIRITTI");
                if ( c == null ) { 
                    c = (com.codecharge.components.Control) model.getControl("DIRITTI").clone();
                    c.setValue(row.getDIRITTI());
                    hashRow.put( c.getName(), c );
                }
...
//AD4_UTENTI Directory: getRowFieldByName @5-88C5FFDC
        public Object getRowFieldByName( String name, AD4_UTENTIRow row ) {
            Object value = null;
            if ( "NOME_GRUPPO".equals(name) ) {
                value = row.getNOME_GRUPPO();
            } else if ( "DIRITTI".equals(name) ) {
                value = row.getDIRITTI();
...
//AdmGruppiElenco Page: method validate @1-104025BA
    boolean validate() {
        return true;
    }
//End AdmGruppiElenco Page: method validate

//AdmGruppiElencoAction Tail @1-FCB6E20C
}
//End AdmGruppiElencoAction Tail
