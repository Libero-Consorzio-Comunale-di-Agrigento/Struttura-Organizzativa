//AD4_UTENTISearch DataSource @6-2CD539AA
...
//End AD4_UTENTISearch DataSource

//class DataObject Header @6-7ED9EFC4
public class AD4_UTENTISearchDataObject extends DS {
//End class DataObject Header

//attributes of DataObject @6-542D7316
    

    TextField urlID = new TextField(null, null);
    

    private AD4_UTENTISearchRow row = new AD4_UTENTISearchRow();

//End attributes of DataObject

//properties of DataObject @6-29A6B2E5
    ...
    public AD4_UTENTISearchRow getRow() {
        return row;
    }

    public void setRow( AD4_UTENTISearchRow row ) {
        this.row = row;
    }

//End properties of DataObject

//constructor @6-23F9B326
    public AD4_UTENTISearchDataObject(Page page) {
        super(page);
    }
//End constructor
...
//load @6-EE14A961
    boolean load() {
        ...
        command.setSql( "select '{SEL_UTENTE}' utente from dual" );
        if ( StringUtils.isEmpty( (String) urlID.getObjectValue() ) ) urlID.setValue( "" );
        command.addParameter( "SEL_UTENTE", urlID, null );
...
//loadDataBind @6-B93A4A8C
        if ( record == null || record.isEmpty() ) {
            empty = true;
        } else {
            row.setID(Utils.convertToString(ds.parse(record.get("UTENTE"), row.getIDField())));
        }
//End loadDataBind
