//AdmUtenteUltimiAccessiAction imports @1-B15DF592
...
//End AdmUtenteUltimiAccessiAction imports

//AdmUtenteUltimiAccessiAction class @1-7E162BD5
public class AdmUtenteUltimiAccessiAction extends Action {

//End AdmUtenteUltimiAccessiAction class

//AdmUtenteUltimiAccessiAction: method perform @1-F11E398A
    public String perform( HttpServletRequest req, HttpServletResponse resp, ServletContext context ) {
        ...
        page = new AdmUtenteUltimiAccessiModel( (CCSLocale) SessionStorage.getInstance( req ).getAttribute(Names.CCS_LOCALE_KEY));
        if (req.getAttribute(page.getName()+"Parent")==null) page.setCharacterEncoding("windows-1252");
        page.setResponse(resp);
        page.setRequest(req);
        res = ResourceBundle.getBundle("MessagesBundle", page.getCCSLocale().getLocale());
        req.setAttribute( "AdmUtenteUltimiAccessiModel", page );
...
//End AdmUtenteUltimiAccessiAction: method perform

//AdmUtenteUltimiAccessiAction: call children actions @1-27D8C3A3
...
//End AdmUtenteUltimiAccessiAction: call children actions
...
//AccessiElenco Grid: set where parameters @6-7CAA7741
...
//AccessiDettaglio Grid: set where parameters @14-B1D9AD75
            ds.setSesMVUTE( SessionStorage.getInstance(req).getAttribute("MVUTE") );
            ds.setUrlDES_ACCESSO( page.getHttpGetParams().getParameter("DES_ACCESSO") );
            ds.setUrlDES_SERVIZIO( page.getHttpGetParams().getParameter("DES_SERVIZIO") );
...
//AdmUtenteUltimiAccessi Page: method validate @1-104025BA
    boolean validate() {
        return true;
    }
//End AdmUtenteUltimiAccessi Page: method validate

//AdmUtenteUltimiAccessiAction Tail @1-FCB6E20C
}
//End AdmUtenteUltimiAccessiAction Tail
