//AdmUtenteUltimiAccessiModel imports @1-64A07F18
...
//End AdmUtenteUltimiAccessiModel imports

//AdmUtenteUltimiAccessiModel class head @1-D8AD88C3
public class AdmUtenteUltimiAccessiModel extends com.codecharge.components.Page {
    public AdmUtenteUltimiAccessiModel() {
        this( new CCSLocale(), null );
    }

    public AdmUtenteUltimiAccessiModel(CCSLocale locale) {
        this( locale, null );
    }

    public AdmUtenteUltimiAccessiModel( CCSLocale locale, HttpServletResponse response ) {
//End AdmUtenteUltimiAccessiModel class head

//page settings @1-59D3AD62
        super("AdmUtenteUltimiAccessi", locale );
        setResponse(response);
        {
            ...
            add( AmvGuida__4 );
            com.codecharge.components.IncludePage AmvUtenteNominativo_i__36 = new com.codecharge.components.IncludePage("AmvUtenteNominativo_i", this );
            AmvUtenteNominativo_i__36.setVisible( true );
            add( AmvUtenteNominativo_i__36 );
...
//AdmUtenteUltimiAccessiModel class tail @1-F5FC18C5
    }
}
//End AdmUtenteUltimiAccessiModel class tail
