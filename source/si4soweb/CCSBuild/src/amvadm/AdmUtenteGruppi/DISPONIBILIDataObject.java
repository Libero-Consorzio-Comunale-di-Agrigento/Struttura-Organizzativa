//DISPONIBILI DataSource @70-91326479
...
//attributes of DataObject @70-64110F7B
    ...
    TextField postGRUPPO_D = new TextField(null, null);
...
//properties of DataObject @70-7563BC75
    ...
    public void  setPostGRUPPO_D( String param ) {
        this.postGRUPPO_D.setValue( param );
    }

    public void  setPostGRUPPO_D( Object param ) {
        this.postGRUPPO_D.setValue( param );
    }

    public void  setPostGRUPPO_D( Object param, Format ignore ) {
        this.postGRUPPO_D.setValue( param );
    }
...
//update @70-5F0471A9
        boolean update() {
            ...
            command.setSql( "insert into AD4_UTENTI_GRUPPO (utente,  "
                        + "gruppo) "
                        + "values (nvl('{MVUTE}','{Utente}'),'{GRUPPO_D}')" );
            ...
            if ( StringUtils.isEmpty( (String) postGRUPPO_D.getObjectValue() ) ) postGRUPPO_D.setValue( "" );
            command.addParameter( "GRUPPO_D", postGRUPPO_D, null );
...
//getParameterByName @70-DBBDD293
        public Parameter getParameterByName(String name, ParameterSource parameterSource) {
            ...
            if ( "GRUPPO_D".equals(name) && "post".equals(prefix) ) {
                param = postGRUPPO_D;
            } else if ( "GRUPPO_D".equals(name) && prefix == null ) {
                param = postGRUPPO_D;
            }
