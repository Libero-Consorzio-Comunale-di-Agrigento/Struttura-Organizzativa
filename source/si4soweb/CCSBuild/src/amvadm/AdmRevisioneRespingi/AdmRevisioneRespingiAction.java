//AdmRevisioneRespingiAction imports @1-005294A8
...
//End AdmRevisioneRespingiAction imports

//AdmRevisioneRespingiAction class @1-B75E3A40
public class AdmRevisioneRespingiAction extends Action {

//End AdmRevisioneRespingiAction class

//AdmRevisioneRespingiAction: method perform @1-32445D66
    public String perform( HttpServletRequest req, HttpServletResponse resp, ServletContext context ) {
        ...
        page = new AdmRevisioneRespingiModel( (CCSLocale) SessionStorage.getInstance( req ).getAttribute(Names.CCS_LOCALE_KEY));
        if (req.getAttribute(page.getName()+"Parent")==null) page.setCharacterEncoding("windows-1252");
        page.setResponse(resp);
        page.setRequest(req);
        res = ResourceBundle.getBundle("MessagesBundle", page.getCCSLocale().getLocale());
        req.setAttribute( "AdmRevisioneRespingiModel", page );
...
//End AdmRevisioneRespingiAction: method perform

//AdmRevisioneRespingiAction: call children actions @1-324435BE
...
//End AdmRevisioneRespingiAction: call children actions
...
//AMV_DOCUMENTO_RESPINGI Record: method perform @6-67883B88
...
//AMV_DOCUMENTO_RESPINGI Record: children actions @6-836394D8
            ...
            read();
            readUTENTE_REDAZIONE(model.getListBox("UTENTE_REDAZIONE"));
...
//ListBoxAction @33-1BCA24B5
        protected void readUTENTE_REDAZIONE(com.codecharge.components.ListBox model) {
            ...
            command.setSql( "SELECT distinct u.UTENTE UTENTE, u.NOMINATIVO NOMINATIVO "
                        ...
                        + "and amv_documento.get_diritto(ug.GRUPPO,d.ID_AREA,doc.ID_TIPOLOGIA) in ('C','A','U') "
                        + "" );
...
//AMV_DOCUMENTO_RESPINGI Record: init DataSource @6-06792D46
            if (!model.isAllowRead()) return;
...
//AMV_DOCUMENTO_RESPINGI Record: bind @6-0192D441
            public void bind(com.codecharge.components.Component model, AMV_DOCUMENTO_RESPINGIRow row ) {
                ...
                if ( this.valid ) {
                    ...
                    model.getControl("UTENTE_REDAZIONE").setValue(row.getUTENTE_REDAZIONE());
                    model.getControl("TIPO_TESTO").setValue(row.getTIPO_TESTO());
                    model.getControl("INOLTRO").setValue(row.getINOLTRO());
...
//AMV_DOCUMENTO_RESPINGI Record: getRowFieldByName @6-9EA5A2E9
            public Object getRowFieldByName( String name, AMV_DOCUMENTO_RESPINGIRow row ) {
                ...
                } else if ( "UTENTE_REDAZIONE".equals(name) ) {
                    value = row.getUTENTE_REDAZIONE();
                } else if ( "TIPO_TESTO".equals(name) ) {
                    value = row.getTIPO_TESTO();
                } else if ( "INOLTRO".equals(name) ) {
                    value = row.getINOLTRO();
...
//AMV_DOCUMENTO_RESPINGI Record: method insert head @6-6D5B77FE
            if (!model.isAllowInsert()) return;
            model.fireBeforeInsertEvent();
//End AMV_DOCUMENTO_RESPINGI Record: method insert head
...
//AMV_DOCUMENTO_RESPINGI Record: method update head @6-AA7E708E
            if (!model.isAllowUpdate()) return;
            model.fireBeforeUpdateEvent();
//End AMV_DOCUMENTO_RESPINGI Record: method update head

//AMV_DOCUMENTO_RESPINGI Record: method update body @6-B8B555E9
            if (!model.isAllowUpdate()) return;
            boolean isErrors = false;
            AMV_DOCUMENTO_RESPINGIDataObject ds = new AMV_DOCUMENTO_RESPINGIDataObject(page);
            ds.setComponent( model );
...
//End AMV_DOCUMENTO_RESPINGI Record: method update body

//AMV_DOCUMENTO_RESPINGI Record: ds.update @6-6E956EDC
            ds.update();
            if ( ! ds.hasErrors() ) {
            }
...
//End AMV_DOCUMENTO_RESPINGI Record: ds.update
...
//AMV_DOCUMENTO_RESPINGI Record: method validate @6-8DF9025E
        boolean validate() {
            ...
            com.codecharge.components.ListBox UTENTE_REDAZIONE = (com.codecharge.components.ListBox) model.getChild( "UTENTE_REDAZIONE" );
            if (! UTENTE_REDAZIONE.validate()) { isControlError = true; }

            com.codecharge.components.Hidden TIPO_TESTO = (com.codecharge.components.Hidden) model.getChild( "TIPO_TESTO" );
            if (! TIPO_TESTO.validate()) { isControlError = true; }

            com.codecharge.components.Hidden INOLTRO = (com.codecharge.components.Hidden) model.getChild( "INOLTRO" );
            if (! INOLTRO.validate()) { isControlError = true; }
...
//AdmRevisioneRespingi Page: method validate @1-104025BA
    boolean validate() {
        return true;
    }
//End AdmRevisioneRespingi Page: method validate

//AdmRevisioneRespingiAction Tail @1-FCB6E20C
}
//End AdmRevisioneRespingiAction Tail
