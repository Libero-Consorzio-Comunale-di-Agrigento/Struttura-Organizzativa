//AMV_DOCUMENTO_REDAZIONE DataSource @6-12496466
...
//End AMV_DOCUMENTO_REDAZIONE DataSource

//class DataObject Header @6-C6ABBB09
public class AMV_DOCUMENTO_REDAZIONEDataObject extends DS {
//End class DataObject Header

//attributes of DataObject @6-09028FFE
    ...
    TextField postVERIFICATORE = new TextField(null, null);
    ...
    private AMV_DOCUMENTO_REDAZIONERow row = new AMV_DOCUMENTO_REDAZIONERow();

//End attributes of DataObject

//properties of DataObject @6-0BE7A101
    ...
    public void  setPostVERIFICATORE( String param ) {
        this.postVERIFICATORE.setValue( param );
    }

    public void  setPostVERIFICATORE( Object param ) {
        this.postVERIFICATORE.setValue( param );
    }

    public void  setPostVERIFICATORE( Object param, Format ignore ) {
        this.postVERIFICATORE.setValue( param );
    }
    ...
    public AMV_DOCUMENTO_REDAZIONERow getRow() {
        return row;
    }

    public void setRow( AMV_DOCUMENTO_REDAZIONERow row ) {
        this.row = row;
    }

//End properties of DataObject

//constructor @6-47661EAB
    public AMV_DOCUMENTO_REDAZIONEDataObject(Page page) {
        super(page);
        addRecordDataObjectListener( new AMV_DOCUMENTO_REDAZIONEDataObjectHandler() );
    }
//End constructor
...
//load @6-2C6FA3B2
    boolean load() {
        ...
        command.setSql( "select d.id_documento "
                    ...
                    + ", r.utente_verifica "
                    + ",  "
                    + "ad4_utente.get_nominativo(r.utente_verifica,'Y',0) nominativo_verifica "
...
//loadDataBind @6-5B6061DA
        if ( record == null || record.isEmpty() ) {
            ...
            row.setVERIFICATORE(Utils.convertToString(ds.parse(record.get("UTENTE_VERIFICA"), row.getVERIFICATOREField())));
...
//update @6-68E35F0A
        boolean update() {
            ...
            if ( StringUtils.isEmpty( (String) postVERIFICATORE.getObjectValue() ) ) postVERIFICATORE.setValue( "" );
            command.addParameter( "P_DESTINATARIO", postVERIFICATORE, java.sql.Types.CHAR, 0, SPParameter.INPUT_PARAMETER );
...
//getParameterByName @6-C5F20671
        public Parameter getParameterByName(String name, ParameterSource parameterSource) {
            ...
            if ( "VERIFICATORE".equals(name) && "post".equals(prefix) ) {
                param = postVERIFICATORE;
            } else if ( "VERIFICATORE".equals(name) && prefix == null ) {
                param = postVERIFICATORE;
            }
