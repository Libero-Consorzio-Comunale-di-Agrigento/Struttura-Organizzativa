//AdmSezioniAction imports @1-D414A104
...
//End AdmSezioniAction imports

//AdmSezioniAction class @1-1F49BE9C
public class AdmSezioniAction extends Action {

//End AdmSezioniAction class

//AdmSezioniAction: method perform @1-CCE13322
    public String perform( HttpServletRequest req, HttpServletResponse resp, ServletContext context ) {
        ...
        page = new AdmSezioniModel( (CCSLocale) SessionStorage.getInstance( req ).getAttribute(Names.CCS_LOCALE_KEY));
        if (req.getAttribute(page.getName()+"Parent")==null) page.setCharacterEncoding("windows-1252");
        page.setResponse(resp);
        page.setRequest(req);
        res = ResourceBundle.getBundle("MessagesBundle", page.getCCSLocale().getLocale());
        req.setAttribute( "AdmSezioniModel", page );
...
//End AdmSezioniAction: method perform

//AdmSezioniAction: call children actions @1-C8B76E0C
        ...
        if ( page.getChild( "AdmSezione" ).isVisible() ) {
            page.getRequest().setAttribute("AdmSezioneParent",page);
            amvadm.AdmSezione.AdmSezioneAction AdmSezione = new amvadm.AdmSezione.AdmSezioneAction();
            result = result != null ? result : AdmSezione.perform( req, resp,  context );
            page.setCookies();
        }
...
//End AdmSezioniAction: call children actions
...
//AdmSezioni Page: method validate @1-104025BA
    boolean validate() {
        return true;
    }
//End AdmSezioni Page: method validate

//AdmSezioniAction Tail @1-FCB6E20C
}
//End AdmSezioniAction Tail
