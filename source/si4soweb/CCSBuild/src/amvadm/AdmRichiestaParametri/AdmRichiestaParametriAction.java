//AdmRichiestaParametriAction imports @1-7474CB71
...
//End AdmRichiestaParametriAction imports

//AdmRichiestaParametriAction class @1-5B227021
public class AdmRichiestaParametriAction extends Action {

//End AdmRichiestaParametriAction class

//AdmRichiestaParametriAction: method perform @1-CC8D8DCF
    public String perform( HttpServletRequest req, HttpServletResponse resp, ServletContext context ) {
        ...
        page = new AdmRichiestaParametriModel( (CCSLocale) SessionStorage.getInstance( req ).getAttribute(Names.CCS_LOCALE_KEY));
        if (req.getAttribute(page.getName()+"Parent")==null) page.setCharacterEncoding("windows-1252");
        page.setResponse(resp);
        page.setRequest(req);
        res = ResourceBundle.getBundle("MessagesBundle", page.getCCSLocale().getLocale());
        req.setAttribute( "AdmRichiestaParametriModel", page );
...
//End AdmRichiestaParametriAction: method perform

//AdmRichiestaParametriAction: call children actions @1-DE2F5231
...
//End AdmRichiestaParametriAction: call children actions
...
//PARAMETRI EditGrid: set where parameters @6-6748F876
...
//PARAMETRI EditGrid: method perform @6-7A780980
...
//Button_Submit Button @12-4E0A6A05
...
//AdmRichiestaParametri Page: method validate @1-104025BA
    boolean validate() {
        return true;
    }
//End AdmRichiestaParametri Page: method validate

//AdmRichiestaParametriAction Tail @1-FCB6E20C
}
//End AdmRichiestaParametriAction Tail
