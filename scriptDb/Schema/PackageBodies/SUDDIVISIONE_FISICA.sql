CREATE OR REPLACE package body suddivisione_fisica is
   /******************************************************************************
    ...
    000   05/11/2007  VDAVALLI  Prima emissione.
    001   04/09/2008  VDAVALLI  Modifiche per configurazione master/slave
    002   14/08/2012  mmonari   Revisione della struttura fisica
    003   26/11/2012  mmonari   Redmine #134
    004   03/10/2013  MMONARI   Redmine #321 suddivisione padre nulla
   ******************************************************************************/
   ...
   end versione; -- suddivisione_fisica.versione
   --------------------------------------------------------------------------------
   ...
   begin
      ...
      dbc.pre(not dbc.preon or canhandle(d_result.id_suddivisione)
             ,'canHandle on suddivisione_fisica.PK');
      return d_result;
   end pk; -- end suddivisione_fisica.PK
   --------------------------------------------------------------------------------
   ...
   begin
      ...
      dbc.post(d_result = 1 or d_result = 0
              ,'d_result = 1  or  d_result = 0 on suddivisione_fisica.can_handle');
      return d_result;
   end can_handle; -- suddivisione_fisica.can_handle
   --------------------------------------------------------------------------------
   ...
   begin
      return d_result;
   end canhandle; -- suddivisione_fisica.canHandle
   --------------------------------------------------------------------------------
   ...
   begin
      dbc.pre(not dbc.preon or canhandle(p_id_suddivisione)
             ,'canHandle on suddivisione_fisica.exists_id');
      begin
         select 1
           into d_result
      ...
      dbc.post(d_result = 1 or d_result = 0
              ,'d_result = 1  or  d_result = 0 on suddivisione_fisica.exists_id');
      return d_result;
   end exists_id; -- suddivisione_fisica.exists_id
   --------------------------------------------------------------------------------
   ...
   begin
      return d_result;
   end existsid; -- suddivisione_fisica.existsId
   --------------------------------------------------------------------------------
   procedure ins
   (
   ...
   begin
      ...
      values
         ...
         ,p_assegnabile
         ,p_ordinamento);
   end ins; -- suddivisione_fisica.ins
   --------------------------------------------------------------------------------
   procedure upd
   (
   ...
   begin
      ...
      dbc.pre(not dbc.preon or existsid(d_key.id_suddivisione)
             ,'existsId on suddivisione_fisica.upd');
      update suddivisioni_fisiche
         set id_suddivisione      = decode(p_check_old
                                          ,0
                                          ,p_new_id_suddivisione
                                          ,decode(p_new_id_suddivisione
                                                 ,p_old_id_suddivisione
                                                 ,id_suddivisione
                                                 ,p_new_id_suddivisione))
            ,amministrazione      = decode(p_check_old
                                          ...
                                          ,decode(p_new_amministrazione
                                                 ...
                                                 ,amministrazione
                                                 ,p_new_amministrazione))
            ,suddivisione         = decode(p_check_old
                                          ,0
                                          ,p_new_suddivisione
                                          ,decode(p_new_suddivisione
                                                 ,p_old_suddivisione
                                                 ,suddivisione
                                                 ,p_new_suddivisione))
            ,denominazione        = decode(p_check_old
                                          ,0
                                          ,p_new_denominazione
                                          ,decode(p_new_denominazione
                                                 ,p_old_denominazione
                                                 ,denominazione
                                                 ,p_new_denominazione))
            ,denominazione_al1    = decode(p_check_old
                                          ,0
                                          ,p_new_denominazione_al1
                                          ,decode(p_new_denominazione_al1
                                                 ,p_old_denominazione_al1
                                                 ,denominazione_al1
                                                 ,p_new_denominazione_al1))
            ,denominazione_al2    = decode(p_check_old
                                          ,0
                                          ,p_new_denominazione_al2
                                          ,decode(p_new_denominazione_al2
                                                 ,p_old_denominazione_al2
                                                 ,denominazione_al2
                                                 ,p_new_denominazione_al2))
            ,des_abb              = decode(p_check_old
                                          ,0
                                          ,p_new_des_abb
                                          ,decode(p_new_des_abb
                                                 ,p_old_des_abb
                                                 ,des_abb
                                                 ,p_new_des_abb))
            ,des_abb_al1          = decode(p_check_old
                                          ,0
                                          ,p_new_des_abb_al1
                                          ,decode(p_new_des_abb_al1
                                                 ,p_old_des_abb_al1
                                                 ,des_abb_al1
                                                 ,p_new_des_abb_al1))
            ,des_abb_al2          = decode(p_check_old
                                          ,0
                                          ,p_new_des_abb_al2
                                          ,decode(p_new_des_abb_al2
                                                 ,p_old_des_abb_al2
                                                 ,des_abb_al2
                                                 ,p_new_des_abb_al2))
            ,icona_standard       = decode(p_check_old
                                          ,0
                                          ,p_new_icona_standard
                                          ,decode(p_new_icona_standard
                                                 ,p_old_icona_standard
                                                 ,icona_standard
                                                 ,p_new_icona_standard))
            ,nota                 = decode(p_check_old
                                          ,0
                                          ,p_new_nota
                                          ,decode(p_new_nota
                                                 ,p_old_nota
   ...
   end upd; -- suddivisione_fisica.upd
   --------------------------------------------------------------------------------
   ...
   begin
      dbc.pre(not dbc.preon or existsid(p_id_suddivisione)
             ,'existsId on suddivisione_fisica.upd_column');
      dbc.pre(not dbc.preon or p_column is not null
             ,'p_column is not null on suddivisione_fisica.upd_column');
      dbc.pre(not dbc.preon or afc_ddl.hasattribute(s_table_name, p_column)
             ,'AFC_DDL.HasAttribute on suddivisione_fisica.upd_column');
      dbc.pre(p_literal_value in (0, 1) or p_literal_value is null
             ,'p_literal_value on suddivisione_fisica.upd_column; p_literal_value = ' ||
              p_literal_value);
      if p_literal_value = 1 or p_literal_value is null then
         d_literal := '''';
      end if;
      d_statement := 'begin ' || '   update suddivisioni_fisiche' || '   set    ' ||
                     p_column || ' = ' || d_literal || p_value || d_literal ||
                     '   where  id_suddivisione = ''' || p_id_suddivisione || '''' ||
                     '   ;' || 'end;';
      afc.sql_execute(d_statement);
   end upd_column; -- suddivisione_fisica.upd_column
   --------------------------------------------------------------------------------
   procedure upd_column
   (
      p_id_suddivisione in suddivisioni_fisiche.id_suddivisione%type
   ...
   begin
      dbc.pre(not dbc.preon or
              not ((p_amministrazione is not null or p_suddivisione is not null or
               p_denominazione is not null or p_denominazione_al1 is not null or
               p_denominazione_al2 is not null or p_des_abb is not null or
               p_des_abb_al1 is not null or p_des_abb_al2 is not null or
               p_icona_standard is not null or p_nota is not null or
               p_utente_aggiornamento is not null or
               p_data_aggiornamento is not null) and (nvl(p_check_old, 0) = 0))
             ,' <OLD values> is not null on suddivisione_fisica.del');
      dbc.pre(not dbc.preon or existsid(p_id_suddivisione)
             ,'existsId on suddivisione_fisica.del');
      ...
      dbc.assertion(not dbc.assertionon or d_row_found <= 1
                   ,'d_row_found <= 1 on suddivisione_fisica.del');
      if d_row_found < 1 then
         raise_application_error(afc_error.modified_by_other_user_number
                                ,afc_error.modified_by_other_user_msg);
      end if;
      dbc.post(not dbc.poston or not existsid(p_id_suddivisione)
              ,'existsId on suddivisione_fisica.del');
   end del; -- suddivisione_fisica.del
   ----------------- get della pk da sequence usata da interfaccia
   function get_id_suddivisione return suddivisioni_fisiche.id_suddivisione%type is
      d_return_value suddivisioni_fisiche.id_suddivisione%type;
   begin
      begin
         select suddivisioni_fisiche_sq.nextval into d_return_value from dual;
      exception
         when others then
            null;
      end;
   ...
   begin
      dbc.pre(not dbc.preon or existsid(p_id_suddivisione)
             ,'existsId on suddivisione_fisica.get_amministrazione');
      ...
      if (true) -- is Mandatory on Table ?
       then
         ...
         dbc.post(not dbc.poston or d_result is not null
                 ,'d_result is not null on suddivisione_fisica.get_amministrazione');
      else
         -- Column must nullable on table
         dbc.assertion(not dbc.assertionon or
                       afc_ddl.isnullable(s_table_name, 'amministrazione')
                      ,' AFC_DDL.IsNullable on suddivisione_fisica.get_amministrazione');
      end if;
      return d_result;
   end get_amministrazione; -- suddivisione_fisica.get_amministrazione
   --------------------------------------------------------------------------------
   ...
   begin
      dbc.pre(not dbc.preon or existsid(p_id_suddivisione)
             ,'existsId on suddivisione_fisica.get_suddivisione');
      select suddivisione
        into d_result
        from suddivisioni_fisiche
       where id_suddivisione = p_id_suddivisione;
      ...
      if (true) -- is Mandatory on Table ?
       then
         -- Result must be not null
         dbc.post(not dbc.poston or d_result is not null
                 ,'d_result is not null on suddivisione_fisica.get_suddivisione');
      else
         -- Column must nullable on table
         dbc.assertion(not dbc.assertionon or
                       afc_ddl.isnullable(s_table_name, 'suddivisione')
                      ,' AFC_DDL.IsNullable on suddivisione_fisica.get_suddivisione');
      end if;
      return d_result;
   end get_suddivisione; -- suddivisione_fisica.get_suddivisione
   --------------------------------------------------------------------------------
   ...
   begin
      dbc.pre(not dbc.preon or existsid(p_id_suddivisione)
             ,'existsId on suddivisione_fisica.get_denominazione');
      ...
      if (true) -- is Mandatory on Table ?
       then
         -- Result must be not null
         dbc.post(not dbc.poston or d_result is not null
                 ,'d_result is not null on suddivisione_fisica.get_denominazione');
      else
         -- Column must nullable on table
         dbc.assertion(not dbc.assertionon or
                       afc_ddl.isnullable(s_table_name, 'denominazione')
                      ,' AFC_DDL.IsNullable on suddivisione_fisica.get_denominazione');
      end if;
      return d_result;
   end get_denominazione; -- suddivisione_fisica.get_denominazione
   --------------------------------------------------------------------------------
   ...
   begin
      dbc.pre(not dbc.preon or existsid(p_id_suddivisione)
             ,'existsId on suddivisione_fisica.get_denominazione_al1');
      ...
      if (false) -- is Mandatory on Table ?
       then
         -- Result must be not null
         dbc.post(not dbc.poston or d_result is not null
                 ,'d_result is not null on suddivisione_fisica.get_denominazione_al1');
      else
         -- Column must nullable on table
         dbc.assertion(not dbc.assertionon or
                       afc_ddl.isnullable(s_table_name, 'denominazione_al1')
                      ,' AFC_DDL.IsNullable on suddivisione_fisica.get_denominazione_al1');
      end if;
      return d_result;
   end get_denominazione_al1; -- suddivisione_fisica.get_denominazione_al1
   --------------------------------------------------------------------------------
   ...
   begin
      dbc.pre(not dbc.preon or existsid(p_id_suddivisione)
             ,'existsId on suddivisione_fisica.get_denominazione_al2');
      ...
      if (false) -- is Mandatory on Table ?
       then
         -- Result must be not null
         dbc.post(not dbc.poston or d_result is not null
                 ,'d_result is not null on suddivisione_fisica.get_denominazione_al2');
      else
         -- Column must nullable on table
         dbc.assertion(not dbc.assertionon or
                       afc_ddl.isnullable(s_table_name, 'denominazione_al2')
                      ,' AFC_DDL.IsNullable on suddivisione_fisica.get_denominazione_al2');
      end if;
      return d_result;
   end get_denominazione_al2; -- suddivisione_fisica.get_denominazione_al2
   --------------------------------------------------------------------------------
   ...
   begin
      dbc.pre(not dbc.preon or existsid(p_id_suddivisione)
             ,'existsId on suddivisione_fisica.get_des_abb');
      select des_abb
        into d_result
        from suddivisioni_fisiche
       where id_suddivisione = p_id_suddivisione;
      ...
      if (false) -- is Mandatory on Table ?
       then
         -- Result must be not null
         dbc.post(not dbc.poston or d_result is not null
                 ,'d_result is not null on suddivisione_fisica.get_des_abb');
      else
         -- Column must nullable on table
         dbc.assertion(not dbc.assertionon or
                       afc_ddl.isnullable(s_table_name, 'des_abb')
                      ,' AFC_DDL.IsNullable on suddivisione_fisica.get_des_abb');
      end if;
      return d_result;
   end get_des_abb; -- suddivisione_fisica.get_des_abb
   --------------------------------------------------------------------------------
   ...
   begin
      dbc.pre(not dbc.preon or existsid(p_id_suddivisione)
             ,'existsId on suddivisione_fisica.get_des_abb_al1');
      select des_abb_al1
        into d_result
        from suddivisioni_fisiche
       where id_suddivisione = p_id_suddivisione;
      ...
      if (false) -- is Mandatory on Table ?
       then
         -- Result must be not null
         dbc.post(not dbc.poston or d_result is not null
                 ,'d_result is not null on suddivisione_fisica.get_des_abb_al1');
      else
         -- Column must nullable on table
         dbc.assertion(not dbc.assertionon or
                       afc_ddl.isnullable(s_table_name, 'des_abb_al1')
                      ,' AFC_DDL.IsNullable on suddivisione_fisica.get_des_abb_al1');
      end if;
      return d_result;
   end get_des_abb_al1; -- suddivisione_fisica.get_des_abb_al1
   --------------------------------------------------------------------------------
   ...
   begin
      dbc.pre(not dbc.preon or existsid(p_id_suddivisione)
             ,'existsId on suddivisione_fisica.get_des_abb_al2');
      select des_abb_al2
        into d_result
        from suddivisioni_fisiche
       where id_suddivisione = p_id_suddivisione;
      ...
      if (false) -- is Mandatory on Table ?
       then
         -- Result must be not null
         dbc.post(not dbc.poston or d_result is not null
                 ,'d_result is not null on suddivisione_fisica.get_des_abb_al2');
      else
         -- Column must nullable on table
         dbc.assertion(not dbc.assertionon or
                       afc_ddl.isnullable(s_table_name, 'des_abb_al2')
                      ,' AFC_DDL.IsNullable on suddivisione_fisica.get_des_abb_al2');
      end if;
      return d_result;
   end get_des_abb_al2; -- suddivisione_fisica.get_des_abb_al2
   --------------------------------------------------------------------------------
   function get_icona_standard(p_id_suddivisione in suddivisioni_fisiche.id_suddivisione%type)
      ...
      /******************************************************************************
       ...
       DESCRIZIONE: Attributo icona_standard di riga esistente identificata dalla chiave.
       PARAMETRI:   Attributi chiave.
   ...
   begin
      dbc.pre(not dbc.preon or existsid(p_id_suddivisione)
             ,'existsId on suddivisione_fisica.get_icona_standard');
      ...
      if (false) -- is Mandatory on Table ?
       then
         -- Result must be not null
         dbc.post(not dbc.poston or d_result is not null
                 ,'d_result is not null on suddivisione_fisica.get_icona_standard');
      else
         -- Column must nullable on table
         dbc.assertion(not dbc.assertionon or
                       afc_ddl.isnullable(s_table_name, 'icona_standard')
                      ,' AFC_DDL.IsNullable on suddivisione_fisica.get_icona_standard');
      end if;
      return d_result;
   end get_icona_standard; -- suddivisione_fisica.get_icona_standard
   --------------------------------------------------------------------------------
   function get_nota(p_id_suddivisione in suddivisioni_fisiche.id_suddivisione%type)
      ...
      /******************************************************************************
       NOME:        get_nota
       DESCRIZIONE: Attributo nota di riga esistente identificata dalla chiave.
       PARAMETRI:   Attributi chiave.
   ...
   begin
      dbc.pre(not dbc.preon or existsid(p_id_suddivisione)
             ,'existsId on suddivisione_fisica.get_nota');
      select nota
        into d_result
        from suddivisioni_fisiche
       where id_suddivisione = p_id_suddivisione;
      ...
      if (false) -- is Mandatory on Table ?
       then
         -- Result must be not null
         dbc.post(not dbc.poston or d_result is not null
                 ,'d_result is not null on suddivisione_fisica.get_nota');
      else
         -- Column must nullable on table
         dbc.assertion(not dbc.assertionon or afc_ddl.isnullable(s_table_name, 'nota')
                      ,' AFC_DDL.IsNullable on suddivisione_fisica.get_nota');
      end if;
      return d_result;
   end get_nota; -- suddivisione_fisica.get_nota
   --------------------------------------------------------------------------------
   ...
   begin
      dbc.pre(not dbc.preon or existsid(p_id_suddivisione)
             ,'existsId on suddivisione_fisica.get_utente_aggiornamento');
      ...
      if (false) -- is Mandatory on Table ?
       then
         -- Result must be not null
         dbc.post(not dbc.poston or d_result is not null
                 ,'d_result is not null on suddivisione_fisica.get_utente_aggiornamento');
      else
         -- Column must nullable on table
         dbc.assertion(not dbc.assertionon or
                       afc_ddl.isnullable(s_table_name, 'utente_aggiornamento')
                      ,' AFC_DDL.IsNullable on suddivisione_fisica.get_utente_aggiornamento');
      end if;
      return d_result;
   end get_utente_aggiornamento; -- suddivisione_fisica.get_utente_aggiornamento
   --------------------------------------------------------------------------------
   ...
   begin
      dbc.pre(not dbc.preon or existsid(p_id_suddivisione)
             ,'existsId on suddivisione_fisica.get_data_aggiornamento');
      ...
      if (false) -- is Mandatory on Table ?
       then
         -- Result must be not null
         dbc.post(not dbc.poston or d_result is not null
                 ,'d_result is not null on suddivisione_fisica.get_data_aggiornamento');
      else
         -- Column must nullable on table
         dbc.assertion(not dbc.assertionon or
                       afc_ddl.isnullable(s_table_name, 'data_aggiornamento')
                      ,' AFC_DDL.IsNullable on suddivisione_fisica.get_data_aggiornamento');
      end if;
      return d_result;
   end get_data_aggiornamento; -- suddivisione_fisica.get_data_aggiornamento
   --------------------------------------------------------------------------------
   --------------------------------------------------------------------------------
   ...
   begin
      ...
      if p_id_suddivisione is not null then
         select ordinamento
           into d_result
           from suddivisioni_fisiche
          where id_suddivisione = p_id_suddivisione;
   ...
   begin
      ...
      return d_statement;
   end where_condition; --- suddivisione_fisica.where_condition
   --------------------------------------------------------------------------------
   function get_rows
   (
      p_id_suddivisione      in varchar2 default null
   ...
   begin
      d_statement  := ' select * from suddivisioni_fisiche ' ||
                      where_condition(p_id_suddivisione
                                     ,p_amministrazione
                                     ,p_suddivisione
                                     ,p_denominazione
                                     ,p_denominazione_al1
      ...
      return d_ref_cursor;
   end get_rows; -- suddivisione_fisica.get_rows
   --------------------------------------------------------------------------------
   function count_rows
   (
      p_id_suddivisione      in varchar2 default null
   ...
   begin
      ...
      return d_result;
   end count_rows; -- suddivisione_fisica.count_rows
--------------------------------------------------------------------------------
