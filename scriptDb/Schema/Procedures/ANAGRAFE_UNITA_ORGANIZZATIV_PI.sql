CREATE OR REPLACE procedure ANAGRAFE_UNITA_ORGANIZZATIV_PI
/******************************************************************************
 NOME:        ANAGRAFE_UNITA_ORGANIZZATIV_PI
 DESCRIZIONE: Procedure for Check REFERENTIAL Integrity
                         at INSERT on Table ANAGRAFE_UNITA_ORGANIZZATIVE
   ...
   cursor cpk1_anagrafe_unita_organizza(var_amministrazione varchar) is
      select 1
       ...
       where CODICE_AMMINISTRAZIONE = var_amministrazione
         ...
         ;
   --  Declaration of InsertChildParentExist constraint for the parent "SUDDIVISIONI_STRUTTURA"
   ...
   cursor cpk5_anagrafe_unita_organizza(var_ottica varchar) is
      select 1
       ...
       where OTTICA = var_ottica
         and var_ottica is not null
         ;
   --  Declaration of InsertChildParentExist constraint for the parent "CENTRI"
...
begin
   begin  -- Check REFERENTIAL Integrity
      begin  --  Parent "AMMINISTRAZIONI" deve esistere quando si inserisce su "ANAGRAFE_UNITA_ORGANIZZATIVE"
         ...
         then
            ...
            if not found then
               errno  := -20002;
               errmsg := 'Non esiste riferimento su Amministrazioni. La registrazione Anagrafe unita organizzative non puo'' essere inserita. (ANAGRAFE_UNITA_ORGANIZZATIVE.ANUO_AMMI_FK)';
      ...
      begin  --  Parent "SUDDIVISIONI_STRUTTURA" deve esistere quando si inserisce su "ANAGRAFE_UNITA_ORGANIZZATIVE"
         ...
         then
            ...
            if not found then
               errno  := -20002;
               errmsg := 'Non esiste riferimento su Suddivisioni Struttura. La registrazione Anagrafe unita organizzative non puo'' essere inserita. (ANAGRAFE_UNITA_ORGANIZZATIVE.ANUO_SUST_FK)';
               raise integrity_error;
            end if;
         end if;
      exception
      ...
      begin  --  Parent "REVISIONI_STRUTTURA" deve esistere quando si inserisce su "ANAGRAFE_UNITA_ORGANIZZATIVE"
      
         if NEW_OTTICA is not null and
            NEW_REVISIONE_ISTITUZIONE is not null
         then
            ...
            if not found then
               errno  := -20002;
               errmsg := 'Non esiste riferimento su Revisioni Struttura. La registrazione Anagrafe unita organizzative non puo'' essere inserita. (ANAGRAFE_UNITA_ORGANIZZATIVE.ANUO_REST_FK)';
               raise integrity_error;
            end if;
         end if;
      exception
      ...
      begin  --  Parent "REVISIONI_STRUTTURA" deve esistere quando si inserisce su "ANAGRAFE_UNITA_ORGANIZZATIVE"
         ...
         then
            ...
            if not found then
               errno  := -20002;
               errmsg := 'Non esiste riferimento su Revisioni Struttura. La registrazione Anagrafe unita organizzative non puo'' essere inserita. (ANAGRAFE_UNITA_ORGANIZZATIVE.ANUO_REST_2_FK)';
               raise integrity_error;
            end if;
         end if;
      exception
      ...
      begin  --  Parent "OTTICHE" deve esistere quando si inserisce su "ANAGRAFE_UNITA_ORGANIZZATIVE"
         ...
         then
            ...
            if not found then
               errno  := -20002;
               errmsg := 'Non esiste riferimento su Ottiche. La registrazione Anagrafe unita organizzative non puo'' essere inserita. (ANAGRAFE_UNITA_ORGANIZZATIVE.ANUO_OTTI_FK)';
               raise integrity_error;
            end if;
         end if;
      exception
      ...
      begin  --  Parent "CENTRI" deve esistere quando si inserisce su "ANAGRAFE_UNITA_ORGANIZZATIVE"
      
         if NEW_CENTRO is not null
         then
            ...
            if not found then
               errno  := -20002;
               errmsg := 'Non esiste riferimento su Centri. La registrazione Anagrafe unita organizzative non puo'' essere inserita. (ANAGRAFE_UNITA_ORGANIZZATIVE.ANUO_CENT_FK)';
               raise integrity_error;
            end if;
         end if;
      exception
      ...
      begin  --  Parent "AOO" deve esistere quando si inserisce su "ANAGRAFE_UNITA_ORGANIZZATIVE"
      
         if NEW_PROGR_AOO is not null
         then
            ...
            if not found then
               errno  := -20002;
               errmsg := 'Non esiste riferimento su AOO. La registrazione Anagrafe unita organizzative non puo'' essere inserita. (ANAGRAFE_UNITA_ORGANIZZATIVE.ANUO_AOO_FK)';
               raise integrity_error;
            end if;
         end if;
      exception
