CREATE OR REPLACE TRIGGER TEMP_CF4_UNITA_PREVISTE_TC
/******************************************************************************
 NOME:        TEMP_CF4_UNITA_PREVISTE_TC
 DESCRIZIONE: Trigger for Custom Functional Check
                    after INSERT or UPDATE or DELETE on Table TEMP_CF4_UNITA_PREVISTE
...
******************************************************************************/
   after INSERT or UPDATE or DELETE on TEMP_CF4_UNITA_PREVISTE
begin
