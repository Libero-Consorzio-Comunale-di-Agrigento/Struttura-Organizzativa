CREATE OR REPLACE TRIGGER ATTRIBUTI_UNITA_FISICA_SO_TC
/******************************************************************************
 NOME:        ATTRIBUTI_UNITA_FISICA_SO_TC
 DESCRIZIONE: Trigger for Custom Functional Check
                    after INSERT or UPDATE or DELETE on Table ATTRIBUTI_UNITA_FISICA_SO
...
******************************************************************************/
   after INSERT or UPDATE or DELETE on ATTRIBUTI_UNITA_FISICA_SO
begin
