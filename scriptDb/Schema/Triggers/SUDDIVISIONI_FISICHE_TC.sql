CREATE OR REPLACE TRIGGER SUDDIVISIONI_FISICHE_TC
/******************************************************************************
 NOME:        SUDDIVISIONI_FISICHE_TC
 DESCRIZIONE: Trigger for Custom Functional Check
                    after INSERT or UPDATE or DELETE on Table SUDDIVISIONI_FISICHE
...
******************************************************************************/
   after INSERT or UPDATE or DELETE on SUDDIVISIONI_FISICHE
begin
